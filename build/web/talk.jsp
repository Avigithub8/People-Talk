  ...
  <body data-spy="scroll" data-target="#my-navbar">
	<nav class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4">
					<img src="getPhoto?email=<%=temail%>" width="120" height="150">
				</div>
				<div class="col-lg-4">
					<div class="form-group">
					</br>
						<label for="name" class="control-label">Name: <font color="grey"><%=tUserDetails.get("name")%></font></label><br>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body text-left">
									...
									<div class="row">
										...
										<div class="form-group">
											<div class="col-lg-2">
                                                                                            <label for="message" class="control-label">File:<a href="downloadFile?filename=<%= message.get("filename")%> &pid=<%= message.get("pid")%>"></a></label><br><br>
											</div>
											<div class="col-lg-2">
									...
									<div class="row">
										<font size="1">
											<div class="form-group">
												...
												<div class="col-lg-2">
                                                                                                    <br><br>
													<label for="message" class="control-label"><br>Date:<%= message.get("datetime")%></label>
												</div>
											</div>
										</font>
									</div>
